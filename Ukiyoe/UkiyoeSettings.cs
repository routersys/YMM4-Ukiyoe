...
internal static class UkiyoeSettings
{
    ...
    public const float MaximumFlattenBeta = 6f;
    public const float FlattenBetaDecay = 5f;
    ...
    public const float QuantizeSharpness = 7f;
    public const float ChromaScale = 0.9f;
    public const float MaximumShiftPixels = 10f;
    public const float BarenStrength = 0.22f;
    public const float BarenRingFrequency = 0.9f;
